...
var wasmBinaryFile = 'ffmpeg_g.wasm';
...
var ASM_CONSTS = {
  3620012: function () { throw 'Canceled!' },
  3620234: function ($0, $1) { setTimeout(function () { _do_emscripten_dispatch_to_thread($0, $1); }, 0); },
  3620336: function () { return TOTAL_STACK }
};
...
var PThread = {
  MAIN_THREAD_ID: 1, mainThreadInfo: { schedPolicy: 0, schedPrio: 0 }, unusedWorkers: [], runningWorkers: [], initMainThreadBlock: function () {
    ...
    var pthreadMainJs = locateFile('ffmpeg_g.worker.js');
...
function ___sys_getrusage(who, usage) {
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(7, 1, who, usage);
  try {
...
function ___sys_mmap2(addr, len, prot, flags, fd, off) {
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(11, 1, addr, len, prot, flags, fd, off);
  try {
...
function _sysconf(name) {
  if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(26, 1, name);
...
var proxiedFunctionTable = [null, _tzset, ___sys__newselect, ___sys_access, ___sys_fcntl64, ___sys_fstat64, ___sys_getdents64, ___sys_getrusage, ___sys_ioctl, ___sys_lstat64, ___sys_mkdir, ___sys_mmap2, ___sys_munmap, ___sys_open, ___sys_prlimit64, ___sys_read, ___sys_rename, ___sys_rmdir, ___sys_stat64, ___sys_unlink, _emscripten_set_canvas_element_size_main_thread, _fd_close, _fd_fdstat_get, _fd_read, _fd_seek, _fd_write, _sysconf];
...
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__call_main": ___call_main, "__clock_gettime": ___clock_gettime, "__gmtime_r": ___gmtime_r, "__localtime_r": ___localtime_r, "__sys__newselect": ___sys__newselect, "__sys_access": ___sys_access, "__sys_fcntl64": ___sys_fcntl64, "__sys_fstat64": ___sys_fstat64, "__sys_getdents64": ___sys_getdents64, "__sys_getrusage": ___sys_getrusage, "__sys_ioctl": ___sys_ioctl, "__sys_lstat64": ___sys_lstat64, "__sys_mkdir": ___sys_mkdir, "__sys_mmap2": ___sys_mmap2, "__sys_munmap": ___sys_munmap, "__sys_open": ___sys_open, "__sys_prlimit64": ___sys_prlimit64, "__sys_read": ___sys_read, "__sys_rename": ___sys_rename, "__sys_rmdir": ___sys_rmdir, "__sys_setrlimit": ___sys_setrlimit, "__sys_stat64": ___sys_stat64, "__sys_unlink": ___sys_unlink, "_emscripten_notify_thread_queue": __emscripten_notify_thread_queue, "abort": _abort, "clock": _clock, "clock_gettime": _clock_gettime, "emscripten_asm_const_int": _emscripten_asm_const_int, "emscripten_check_blocking_allowed": _emscripten_check_blocking_allowed, "emscripten_conditional_set_current_thread_status": _emscripten_conditional_set_current_thread_status, "emscripten_futex_wait": _emscripten_futex_wait, "emscripten_futex_wake": _emscripten_futex_wake, "emscripten_get_now": _emscripten_get_now, "emscripten_has_threading_support": _emscripten_has_threading_support, "emscripten_is_main_browser_thread": _emscripten_is_main_browser_thread, "emscripten_is_main_runtime_thread": _emscripten_is_main_runtime_thread, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_receive_on_main_thread_js": _emscripten_receive_on_main_thread_js, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_set_canvas_element_size": _emscripten_set_canvas_element_size, "emscripten_set_current_thread_status": _emscripten_set_current_thread_status, "emscripten_set_thread_name": _emscripten_set_thread_name, "emscripten_webgl_create_context": _emscripten_webgl_create_context, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "exit": _exit, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "gettimeofday": _gettimeofday, "gmtime_r": _gmtime_r, "initPthreadsJS": initPthreadsJS, "localtime_r": _localtime_r, "memory": wasmMemory, "mktime": _mktime, "pthread_cleanup_pop": _pthread_cleanup_pop, "pthread_cleanup_push": _pthread_cleanup_push, "pthread_create": _pthread_create, "pthread_join": _pthread_join, "pthread_self": _pthread_self, "setTempRet0": _setTempRet0, "signal": _signal, "strftime": _strftime, "sysconf": _sysconf, "time": _time };
var asm = createWasm();
/** @type {function(...*):?} */
...
var _ff_h264_cabac_tables = Module['_ff_h264_cabac_tables'] = 1503125;
var _main_thread_futex = Module['_main_thread_futex'] = 13079500;
